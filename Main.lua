...
local Cache = {}
local TrinketType = loadstring(game:HttpGet("https://raw.githubusercontent.com/roguemoddedpublic/rlmscript/refs/heads/RogueLineageModded/Trinket_ESP/TrinketType.lua"))()
